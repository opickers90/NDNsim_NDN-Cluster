...
int
    main(int argc, char* argv[])
    {
        ...
        //cluster.installWifiStaAp (consumersNodes,wifiAPNodes,propogationRange);
        ...
        //cluster.installConsumer (wifiAPNodes, prefix, frequency);
        //cluster.installClusterHead (wifiAPNodes, prefix);
        cluster.installClusterConsumer (consumersNodes, prefix, frequency);
        ...
        //ndn::StrategyChoiceHelper::Install<nfd::fw::ClusterStrategy>(consumersNodes, prefix);
        ndn::StrategyChoiceHelper::Install(produserNodes, prefix, "/localhost/nfd/strategy/multicast");
        ndn::StrategyChoiceHelper::Install(routerNodes, prefix, "/localhost/nfd/strategy/best-route");
        ndn::StrategyChoiceHelper::Install(wifiAPNodes, prefix, "/localhost/nfd/strategy/broadcast");
